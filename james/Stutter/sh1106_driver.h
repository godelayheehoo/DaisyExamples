  ...
  public:
    ...
    void Update()
    {
        ...
        for(i = 0; i < (height / 8); i++)
        {
            ...
            transport_.SendCommand(0x02); // SH1106 offset (sets column lower nibble to 2)
...
using SH1106I2c128x64Driver = SH1106Driver<128, 64, daisy::SSD130xI2CTransport>;
